...
## Purpose
Describe how the static Jekyll site can be protected by an optional repository-managed password gate while remaining compatible with GitHub Pages hosting.
## Requirements
