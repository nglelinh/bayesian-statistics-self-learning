...
- [ ] 1.4 Extract and verify image-based Session 3 examples with OCR/manual image review, then map each recovered example to a target lesson section.
...
- [ ] 2.3 Add at least one OCR-recovered Session 3 worked example (or explicitly equivalent reconstructed example) with full equations and interpretation.
- [ ] 2.4 Update chapter-level orientation/cross-links so learners can find Session 3 additions in sequence.
