...
![Phân phối Bernoulli](/bayesian-statistics-self-learning/img/chapter_img/chapter00/bernoulli_distribution.png)
*Hình 1: Phân phối Bernoulli với các giá trị khác nhau của tham số p. Khi p = 0.5, thí nghiệm là công bằng (như tung đồng xu cân bằng). Khi p = 0.8, thành công rất có khả năng xảy ra. Khi p = 0.2, thất bại là kết quả thường gặp hơn.*
...
![Phân phối Binomial](/bayesian-statistics-self-learning/img/chapter_img/chapter00/binomial_distribution.png)
*Hình 2: Phân phối Binomial với các tham số khác nhau. Lưu ý cách hình dạng thay đổi khi số lần thử n và xác suất thành công p thay đổi. Với n lớn và p trung bình (0.5), phân phối có dạng đối xứng giống chuông. Với p nhỏ hoặc lớn, phân phối lệch sang một bên.*


### Ví dụ Tung Đồng Xu — Khoảng Tin Cậy 95% (Frequentist)

Giả sử ta tung một đồng xu **10 lần** và quan sát được:

- Số lần tung: `n = 10`
- Số lần ra **Ngửa (Heads)**: `x = 8`

Ước lượng xác suất:

$$
\hat{p} = \frac{x}{n} = \frac{8}{10} = 0.8
$$

Ta muốn tính **khoảng tin cậy** cho xác suất thật $$p$$.

Khoảng `[0.49, 0.95]` thường được tính bằng **Wilson score interval**, vì phương pháp này chính xác hơn **normal approximation** khi $$n$$ nhỏ.

### Công thức Wilson Confidence Interval

$$
CI =
\frac{\hat p + \frac{z^2}{2n} \pm
z\sqrt{\frac{\hat p(1-\hat p)+\frac{z^2}{4n}}{n}}}
{1+\frac{z^2}{n}}
$$

Trong đó:

- $$\hat p$$: tỉ lệ quan sát được
- $$n$$: số lần thử
- $$z$$: giá trị tới hạn của phân phối chuẩn

Với **95% confidence level**:
...
$$
\frac{z^2}{4n} = \frac{3.8416}{40} = 0.09604
$$

$$
0.16 + 0.09604 = 0.25604
$$

$$
\frac{0.25604}{10} = 0.025604
$$

$$
\sqrt{0.025604} \approx 0.160
$$
...
$$
1.96 \times 0.160 = 0.3136
$$

---

# Khoảng tin cậy cuối cùng

### Cận dưới

$$
\frac{0.99208 - 0.3136}{1.38416}
=
0.49
$$
...
Trong những tình huống này, **phân phối Poisson** thường là mô hình phù hợp. Một biến ngẫu nhiên $$X$$ tuân theo phân phối Poisson với tham số $$\lambda$$ **(tốc độ trung bình của sự kiện - số lần một sự kiện xảy ra trong một khoảng thời gian cố định)** nếu:
...
![Phân phối Poisson](/bayesian-statistics-self-learning/img/chapter_img/chapter00/poisson_distribution.png)
*Hình 3: Phân phối Poisson với các giá trị λ khác nhau, từ sự kiện hiếm (λ = 1) đến sự kiện thường xuyên (λ = 10). Lưu ý rằng khi λ tăng, phân phối trở nên đối xứng hơn và gần với phân phối chuẩn hơn.*
...
![Phân phối Chuẩn](/bayesian-statistics-self-learning/img/chapter_img/chapter00/normal_distribution.png)
*Hình 4: Phân phối chuẩn với các tham số khác nhau. Bên trái: So sánh các phân phối với trung bình và độ lệch chuẩn khác nhau. Bên phải: Quy tắc 68-95-99.7, cho thấy xác suất nằm trong 1, 2, và 3 độ lệch chuẩn từ trung bình.*
...
![Phân phối Beta](/bayesian-statistics-self-learning/img/chapter_img/chapter00/beta_distribution.png)
*Hình 5: Sự linh hoạt của phân phối Beta. Với các giá trị khác nhau của α và β, phân phối có thể là đồng nhất (1,1), đối xứng tập trung (10,10), lệch phải (2,5), lệch trái (5,2), hoặc hình chữ U (0.5,0.5). Đây là lý do Beta là lựa chọn phổ biến để mô hình hóa xác suất và tỷ lệ trong phân tích Bayesian.*
...
![Phân phối Mũ](/bayesian-statistics-self-learning/img/chapter_img/chapter00/exponential_distribution.png)
*Hình 6: Phân phối mũ với các tham số λ khác nhau (bên trái) và minh họa tính không nhớ (bên phải). Lưu ý rằng phân phối luôn giảm dần từ giá trị lớn nhất tại x = 0. Tính không nhớ có nghĩa là xác suất chờ thêm t đơn vị thời gian giống nhau bất kể đã chờ bao lâu.*
...
![Phân phối Gamma](/bayesian-statistics-self-learning/img/chapter_img/chapter00/gamma_distribution.png)
*Hình 7: Phân phối Gamma với các tham số hình dạng (α) khác nhau. Khi α = 1, ta có phân phối mũ. Khi α tăng, phân phối có đỉnh rõ ràng hơn và hình dạng giống chuông hơn. Phân phối Gamma rất hữu ích trong mô hình hóa thời gian chờ đợi và như prior cho các tham số dương trong phân tích Bayesian.*
...
![Tổng quan Các Phân phối](/bayesian-statistics-self-learning/img/chapter_img/chapter00/distributions_overview.png)
*Hình 8: Bảng tổng quan các phân phối xác suất quan trọng trong bài học này. Mỗi phân phối có miền giá trị, tham số, và ứng dụng điển hình riêng. Hiểu được khi nào sử dụng phân phối nào là một kỹ năng quan trọng trong mô hình hóa thống kê và Bayesian.*
