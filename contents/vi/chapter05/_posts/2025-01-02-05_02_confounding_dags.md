...
Sau bài này, bạn cần hiểu confounding là gì và vì sao nó làm ta đọc sai dữ liệu. Bạn cũng cần biết DAG là công cụ để suy nghĩ về quan hệ nhân quả, từ đó quyết định khi nào nên điều chỉnh một biến và khi nào không nên. Đây là nền móng của causal inference.
...
>
> **Câu hỏi tự kiểm tra.** Nếu một biến ảnh hưởng đồng thời tới cả treatment và outcome, chuyện gì có thể xảy ra nếu ta bỏ qua nó?
...
- doanh số kem tăng vào mùa hè,
- số vụ đuối nước cũng tăng vào mùa hè.

Điều đó không có nghĩa kem gây đuối nước. Cả hai cùng tăng vì **thời tiết nóng**.

Vấn đề ở đây là:

- ta nhìn thấy một tương quan,
- nhưng không thấy cấu trúc tạo ra tương quan đó.

Confounding chính là một trong những lý do phổ biến nhất khiến ta nhầm từ tương quan sang nhân quả.

## 2. Confounder là gì?

Một biến được gọi là **confounder** nếu nó:

1. ảnh hưởng đến predictor hay treatment $$X$$,
2. đồng thời ảnh hưởng đến outcome $$Y$$,
3. nhưng không nằm trên con đường nhân quả từ $$X$$ đến $$Y$$.
...
- **Directed**: các mũi tên có hướng,
- **Acyclic**: không có vòng lặp khép kín,
- **Graph**: là sơ đồ quan hệ giữa các biến.
...
- tuổi ảnh hưởng đến mức độ tập luyện,
- tuổi cũng ảnh hưởng đến huyết áp.

Nếu đang muốn nghiên cứu tập luyện ảnh hưởng thế nào đến huyết áp, **tuổi** là biến nên điều chỉnh.
...
- tập luyện làm giảm cân,
- giảm cân giúp cải thiện đường huyết.
...
- năng lực và may mắn đều ảnh hưởng đến việc được tuyển dụng,
- nếu chỉ nhìn nhóm đã được tuyển, ta có thể thấy người "ít may mắn" lại thường "rất giỏi" và ngược lại.
...
Một bản nhớ ngắn gọn:

- **nên control cho confounders**,
- **không nên control cho mediators** nếu mục tiêu là total effect,
- **không nên control cho colliders**.

Nghe đơn giản, nhưng muốn áp dụng đúng thì phải có sơ đồ nhân quả đủ rõ.
...
- nhìn toàn bộ dữ liệu thì một xu hướng xuất hiện,
- nhưng khi tách theo nhóm quan trọng thì xu hướng đảo chiều.

Ví dụ trong y khoa:

- nhìn tổng thể, nhóm điều trị tích cực có vẻ hồi phục kém hơn,
- nhưng khi tách bệnh nhân theo mức độ nặng nhẹ, trong từng nhóm mức độ bệnh thì điều trị tích cực lại tốt hơn.

Nguyên nhân là:

- ca nặng được điều trị mạnh hơn,
- ca nặng cũng khó hồi phục hơn.
...
Một **backdoor path** là con đường phi nhân quả nối từ treatment $$X$$ tới outcome $$Y$$ thông qua các nguyên nhân chung.

Mục tiêu của adjustment là:

- chặn các backdoor paths,
- nhưng không chặn đường tác động nhân quả thật từ $$X$$ đến $$Y$$.

![Backdoor paths examples]({{ site.baseurl }}/img/chapter_img/chapter05/backdoor_paths_examples.png)

Ví dụ:

- ta muốn biết học thêm $$X$$ ảnh hưởng thế nào tới điểm thi $$Y$$,
- năng lực ban đầu $$Z$$ ảnh hưởng cả việc đi học thêm lẫn điểm thi.

Khi đó đường $$X \leftarrow Z \rightarrow Y$$ là backdoor path. Điều chỉnh cho $$Z$$ sẽ giúp chặn đường này.
...
Một **adjustment set hợp lệ** là tập biến giúp:

- chặn tất cả backdoor paths cần chặn,
- không mở ra các đường sai mới,
- không vô tình chặn mất phần hiệu quả mà ta đang muốn đo.

Ta không cần điều chỉnh "càng nhiều càng tốt". Ta cần điều chỉnh **đúng biến**.

### Ví dụ thực tế

Nghiên cứu tác động của tập luyện lên sức khỏe tim mạch:

- **tuổi** và **thói quen ăn uống** có thể là confounders,
- **cân nặng hiện tại** có thể là mediator,
- **số lần nhập viện** có thể là collider nếu nó vừa chịu ảnh hưởng của sức khỏe vừa liên quan tới khả năng được theo dõi y tế.

Nếu ta nhét tất cả vào một mô hình mà không suy nghĩ, ta rất dễ tự tạo bias.
...
- năng lực và may mắn đều ảnh hưởng đến việc đỗ vào một công ty cạnh tranh cao,
- trong dân số chung, năng lực và may mắn có thể không liên quan,
- nhưng trong nhóm đã trúng tuyển, người kém may mắn hơn thường phải giỏi hơn để vẫn đỗ.
...
Khi gặp một câu hỏi nhân quả, bạn có thể đi theo 4 bước:
...
- hay chỉ muốn dự đoán $$Y$$?

Nếu mục tiêu là nhân quả, DAG trở nên đặc biệt quan trọng.

### Bước 2. Liệt kê các biến liên quan

Hãy nghĩ bằng ngôn ngữ đời thường:

- điều gì ảnh hưởng đến treatment?
- điều gì ảnh hưởng đến outcome?
- điều gì nằm ở giữa treatment và outcome?
- điều gì là kết quả chung của hai thứ khác nhau?
...
- biến nào cần điều chỉnh để chặn backdoor paths,
- biến nào không được điều chỉnh vì là mediator hoặc collider.
...
- vẽ ví dụ ice cream và đuối nước,
- vẽ ví dụ học thêm và điểm thi,
- vẽ ví dụ exercise, weight loss, health,
- đổi một biến từ confounder thành collider để xem logic thay đổi ra sao.
...
Nếu không suy nghĩ nhân quả trước:

- hồi quy có thể chạy rất đẹp,
- interval có thể trông rất thuyết phục,
- nhưng câu kết luận cuối cùng vẫn sai.

> **3 ý cần nhớ.**
>
> Confounder là biến ảnh hưởng đồng thời tới treatment và outcome, nên nếu bỏ qua nó ta dễ ước lượng sai hiệu quả mình quan tâm.
>
> DAG là công cụ để vẽ cấu trúc nhân quả trước khi chạy mô hình, giúp quyết định biến nào nên và không nên điều chỉnh.
>
> Không nên "control cho mọi thứ": confounders thường cần điều chỉnh, còn mediators và colliders thì phải xử lý cẩn thận tùy câu hỏi.
